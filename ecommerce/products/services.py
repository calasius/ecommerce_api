...
async def create_new_product(request: schema.Product, database: Session):
    ...
    new_product = models.Product(name=request.name, price=request.price, category_id=request.category_id, description=request.description, quantity=request.quantity)
